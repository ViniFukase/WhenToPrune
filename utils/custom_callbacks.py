...
#         print(f"Tempo da Época {epoch+1}: {self.times[-1]} segundos.")          

class TimeHistory(Callback):  
    def __init__(self, times_list):  
        super().__init__()  
        # Uma referência à lista externa para armazenar os tempos  
    ...
    def on_epoch_end(self, epoch, logs=None):  
        # Atualizando a lista externa  
        self.times_list.append(time.time() - self.epoch_start_time) 
