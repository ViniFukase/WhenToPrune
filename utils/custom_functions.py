...
def cifar_resnet_data(debug=False, validation_set=False, cifar=10):
    print('Debuging Mode') if debug is True else print('Real Mode')
    ...
    y_train = keras.utils.to_categorical(y_train, cifar)
    y_test = keras.utils.to_categorical(y_test, cifar)
    #y_test = np.argmax(y_test, axis=1)
